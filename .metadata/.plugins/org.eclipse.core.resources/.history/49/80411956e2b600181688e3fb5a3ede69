            ...
            <div class="cd-tab-filter-wrapper">
                <div class="cd-tab-filter">
                    <ul class="cd-filters">
                        ...
                        <li class="filter" data-filter=".color-1"><a href="#" data-type="color-1">Aberta</a></li>
                        <li class="filter" data-filter=".color-2"><a href="#" data-type="color-2">Privada</a></li>
                ...
                <form>
                    <div class="cd-filter-block">
                        ...
                        <div class="cd-filter-content">
                            <input type="search" placeholder="Nome Jogo">
                        </div>
                        <!-- cd-filter-content -->
                    </div>
                    <!-- cd-filter-block -->
